    ...
    <div className="grid grid-cols-1 xl:grid xl:grid-cols-[17.5fr_82.5fr] h-screen bg-bg_color">
      ...
      >
        <div className="flex flex-col items-center justify-between pt-24">
          {/* Profile Picture */}
          <div className="flex flex-col items-center justify-between">
            <div className="rounded-full bg-[#5F9EA0] w-32 h-32 lg:w-48 lg:h-48"> 
              <Image 
                src={"/profile.jpg"}
                alt=""
                width={300}
            ...
            {/* Name */}
            <h2 className="text-2xl lg:text-3xl text-center pt-8">Chua Jun Jie (CJ)</h2>
          </div>
      ...
      <div className="snap-y snap-mandatory overflow-y-scroll">
        ...
        {/* About Me */}
        <div id="about" className="snap-start h-screen flex flex-col text-base pt-12 pl-8 pr-8 gap-y-4 sm:text-lg md:text-xl xl:text-2xl 2xl:text-3xl sm:pt-16 sm:pl-12 sm:pr-12 sm:gap-y-12 md:pt-16 md:pl-16 md:pr-16 md:gap-y-16 lg:pt-24 lg:pl-24 lg:pr-24 lg:gap-y-24 2xl:pt-32 2xl:pl-32 2xl:pr-32 2xl:gap-y-24 relative bg-footer-pattern bg-right-bottom bg-no-repeat">
          {/* Title */}
          ...
          <div className="flex flex-col gap-y-2">
            ...
            <div className="flex flex-row gap-x-3 gap-y-2 text-sm sm:text-lg md:text-xl xl:text-2xl flex-wrap">
        ...
        <div id="resume" className="snap-start h-screen flex flex-col text-base pt-12 pl-8 pr-8 gap-y-4 sm:text-lg md:text-xl xl:text-2xl 2xl:text-3xl sm:pt-16 sm:pl-12 sm:pr-12 sm:gap-y-12 md:pt-16 md:pl-16 md:pr-16 md:gap-y-16 lg:pt-24 lg:pl-24 lg:pr-24 lg:gap-y-16 xl:pt-24 xl:pl-24 xl:pr-24 xl:gap-y-16 2xl:pt-32 2xl:pl-32 2xl:pr-32 2xl:gap-y-16 relative bg-footer-pattern bg-right-bottom bg-no-repeat">
          {/* Title */}
          <div className="underline decoration-[#b48b77] underline-offset-4">Resume</div>
          <div className="sm:grid sm:grid-cols-[1fr_1fr]">

            <div className="flex flex-col gap-y-4">
              <h2 className="text-base sm:text-lg md:text-xl xl:text-2xl">Education</h2>
              
              <div className="flex flex-row gap-x-4 relative">
                <div className="flex items-start">
                  <Image src={"/graduation.svg"} alt="" width={48} height={48} />
                </div>
                <div className="flex flex-col">
                  <h3 className="text-xs sm:text-lg md:text-xl xl:text-2xl">Monash University Malaysia</h3>
                  <div className="flex flex-col text-xs xl:text-lg italic">
              ...
              <div className="flex flex-row gap-x-4 relative md:mt-16">
                <div className="flex items-start">
                  <Image src={"/graduation.svg"} alt="" width={48} height={48} />
                </div>
                <div className="flex flex-col">
                  <h3 className="text-xs sm:text-lg md:text-xl xl:text-2xl">Sunway College</h3>
                  <div className="flex flex-col text-xs xl:text-lg italic">
              ...
              <div className="flex flex-row gap-x-4 relative md:mt-16">
                ...
                <div className="flex flex-col">
                  <h3 className="text-xs sm:text-lg md:text-xl xl:text-2xl">Chong Hwa Independent High School</h3>
                  <div className="flex flex-col text-xs xl:text-lg italic">
                    <p>High School</p>
            ...
            <div className="flex flex-col gap-y-4 mt-8 sm:mt-0">
              <h2 className="text-base sm:text-lg md:text-xl xl:text-2xl">Work Experience</h2>
              
              <div className="flex flex-row gap-x-4 relative">
                <div className="flex items-start">
                  <Image src={"/work.svg"} alt="" width={48} height={48} layout="fixed"/>
                </div>
                <div className="flex flex-col">
                  <h3 className="text-xs sm:text-lg md:text-xl xl:text-2xl">Selangor Human Resource Development Centre (SHRDC)</h3>
                  <div className="flex flex-col text-xs xl:text-lg italic">
        ...
        <div id="portfolio" className="snap-start h-screen flex flex-col text-base pt-12 pl-8 pr-8 gap-y-4 sm:text-lg md:text-xl xl:text-2xl 2xl:text-3xl sm:pt-16 sm:pl-12 sm:pr-12 sm:gap-y-12 md:pt-16 md:pl-16 md:pr-16 md:gap-y-16 lg:pt-24 lg:pl-24 lg:pr-24 lg:gap-y-24 xl:pt-32 xl:pl-32 xl:pr-32 xl:gap-y-12 relative bg-footer-pattern bg-right-bottom bg-no-repeat">
                ...
                <Link href={`/${project.id}`}>
                  <div className="flex flex-col gap-y-4 items-center">
                    <Image
                      ...
                      height={300}
                    />
                    <h2 className="text-center text-base sm:text-lg md:text-xl xl:text-2xl">{ project.title } ({ project.type })</h2>
                  </div>
                </Link>
              </div>
            ))}
